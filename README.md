...
```
nibble: CLI driver for the Mysz programming language

Usage: nibble <COMMAND>

Commands:
  build   Compile a .mysz file into a native executable or library
  run     Compile and run a .mysz file in one step
  help    Show this message, or help for a specific subcommand
```